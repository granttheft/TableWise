...
/// <summary>
/// UpdateVenueCustomFieldDto için FluentValidation kuralları.
/// </summary>
public sealed class UpdateVenueCustomFieldDtoValidator : AbstractValidator<UpdateVenueCustomFieldDto>
{
    public UpdateVenueCustomFieldDtoValidator()
    {
        RuleFor(x => x.Label)
