...
/// <summary>
/// RegisterTenantDto için FluentValidation kuralları.
/// </summary>
public sealed class RegisterTenantDtoValidator : AbstractValidator<RegisterTenantDto>
{
    /// <summary>
    /// RegisterTenantDtoValidator constructor.
    /// </summary>
    public RegisterTenantDtoValidator()
    {
        ...
        RuleFor(x => x.AcceptTerms)
            .Equal(true).WithMessage("Kullanım koşullarını ve KVKK aydınlatma metnini kabul etmelisiniz.");
    }
}
