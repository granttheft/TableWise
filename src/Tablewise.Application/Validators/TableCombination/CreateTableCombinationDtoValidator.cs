...
/// <summary>
/// CreateTableCombinationDto için FluentValidation kuralları.
/// </summary>
public sealed class CreateTableCombinationDtoValidator : AbstractValidator<CreateTableCombinationDto>
{
    public CreateTableCombinationDtoValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.CombinedCapacity)
            ...
            .When(x => x.CombinedCapacity.HasValue);
    }
}
