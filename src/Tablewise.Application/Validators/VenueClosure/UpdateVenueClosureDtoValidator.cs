...
/// <summary>
/// UpdateVenueClosureDto için FluentValidation kuralları.
/// </summary>
public sealed class UpdateVenueClosureDtoValidator : AbstractValidator<UpdateVenueClosureDto>
{
    public UpdateVenueClosureDtoValidator()
    {
        RuleFor(x => x.Date)
